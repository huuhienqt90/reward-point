...
if ( ! class_exists( 'RWP_Admin_Settings' ) ) :

/**
 * WC_Admin_Settings
 */
class RWP_Admin_Settings {
	...
	public static function get_settings_pages() {
		if ( empty( self::$settings ) ) {
			...
			//$settings[] = include( 'class-wc-settings-general.php' );

			self::$settings = apply_filters( 'rewardpoint_get_settings_pages', $settings );
		}
	...
	public static function save() {
	    ...
	    // Trigger actions
	   	do_action( 'rewardpoint_settings_save_' . $current_tab );
	    do_action( 'rewardpoint_update_options_' . $current_tab );
	    do_action( 'rewardpoint_update_options' );

    	// Clear any unwanted data
		wc_delete_product_transients();
		delete_transient( 'rewardpoint_cache_excluded_uris' );
		...
		do_action( 'rewardpoint_settings_saved' );
	}
